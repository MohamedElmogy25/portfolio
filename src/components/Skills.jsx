...
const skillCategories = [
    ...
    },
    {
        ...
        icon: '🧬',
        skills: [
            { name: 'Biopython', icon: FiDatabase, level: 82, color: '#acbac4' },
            { name: 'BLAST', icon: FiDatabase, level: 78, color: '#e1d9bc' },
            { name: 'FASTA', icon: FiDatabase, level: 80, color: '#acbac4' },
            { name: 'OpenCV', icon: FiDatabase, level: 85, color: '#e1d9bc' },
        ],
    },
]
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <FadeIn delay={0.4}>
                    <div className="mt-6 rounded-2xl p-6 border border-violet-500/12"
                        style={{ background: 'rgba(225,217,188,0.04)' }}>
